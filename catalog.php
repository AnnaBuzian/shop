...
<section>
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="panel-title">Товаров в <a href="basket.php">корзине</a>: <?=$count?></h4>
            </div>
            <div class="col-sm-12">
                <div class="alert alert-danger alert-dismissable fade in" style="display: none;" id="notRowsCatalog">
                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                    <strong>Ошибка!</strong>
                    <div id="errorMsg">Нет товаров в каталоге</div>
                </div>
                <table class="table table-striped">
                    ...
                    <?php
                        ...
                        if(!$goods){
                            echo "<script type='text/javascript'>$('#notRowsCatalog #errorMsg]').html('Товаров нет'); $('#notRowsCatalog').show();</script>";
                        }
